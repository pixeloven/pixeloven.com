...
import { CloseButton, Popover, PopoverButton, PopoverOverlay, PopoverPanel, Transition, TransitionChild } from "@headlessui/react";
...
function MobileNavLink(props: PropsWithChildren<MobileNavLinkProps>) {
  ...
  return (
    <CloseButton as={Link} href={href} className="block w-full p-2">
      {children}
    </CloseButton>
  );
}
